    ...
    <div v-show="visible" class="date-range-panel">
      ...
      <div class="panel-item">
        ...
        <date-spinner
          ref="minSpinner"
          :date="minDate"
          @change="handleMinChange"></date-spinner>
      </div>
      <!-- max date -->
      <div class="panel-item">
        <div class="header-wrapper">
        ...
        <date-spinner
          ref="maxSpinner"
          :date="maxDate"
          @change="handleMaxChange"></date-spinner>
      </div>
...
export default {
  ...
  methods: {
    ...
    handleChange(){
      if(this.isValidValue([this.minDate, this.maxDate])){
        this.$refs.minSpinner.selectableRange = [Number.NEGATIVE_INFINITY, this.maxDate]
        this.$refs.maxSpinner.selectableRange = [this.minDate, Number.POSITIVE_INFINITY]
